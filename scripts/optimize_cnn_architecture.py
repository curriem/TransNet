...
class model_setup():
    ...
    def model_architecture(self):
        model = Sequential()
        model.add(Conv2D(self.l1_out, (3, 3), input_shape=(im_len, im_len,
                                                           num_channels),
                         activation='relu'))
        model.add(MaxPooling2D(pool_size=(2, 2)))
        model.add(Dropout(self.l1_drop))
        model.add(Conv2D(self.l2_out, (3, 3), activation='relu'))
        model.add(MaxPooling2D(pool_size=(2, 2)))
...
bounds = [{'name': 'validation_split', 'type': 'continuous',  'domain': (0.0,
          ...
          {'name': 'l2_drop',          'type': 'continuous',  'domain': (0.0,
                                                                         0.3)},
          {'name': 'l1_out',           'type': 'discrete',    'domain': (32,
                                                                         64,
                                                                         128,
                                                                         256,
                                                                         512,
                                                                         1024)},
          {'name': 'l2_out',           'type': 'discrete',    'domain': (32,
                                                                         64,
                                                                         128,
                                                                         256,
                                                                         512,
